...
## How to create or access a egment
...
Formally speaking, **Segment (1)** on the left of the screen shown below is a set of **Players** that belong to at least one group.
