...
- Open Game Manager. If you are unfamiliar with Game Manager, see the [Game Manager Tour](../../config/gamemanager/game-manager-tour.md).
...
CloudScript is an advanced topic that is covered in the tutorial [Using CloudScript](../../automation/cloudscript/using-cloudscript.md). Player data does not require CloudScript. It is, however, accessible from CloudScript if you require it.
...
[Using CloudScript](../../automation/cloudscript/using-cloudscript.md)
