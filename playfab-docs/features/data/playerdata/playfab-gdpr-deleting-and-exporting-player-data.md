...
> [!NOTE]
> This tutorial focuses on how to use these **Admin APIs** to export or delete a player' data. We plan to expose comparable functionality through Game Manager by May 25, 2018.
