...
> [!NOTE]
> This article frequently references available Azure compute series and regions. To review current selection and pricing for PlayFab, see [Multiplayer Servers - detailed price sheet](https://playfab.com/mps-detailed-pricing/).
