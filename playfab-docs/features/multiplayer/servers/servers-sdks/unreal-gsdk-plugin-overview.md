---
title: PlayFab Unreal GSDK plugin
description: Overview of the PlayFab Multiplayer GSDK plugin for Unreal
author: joannaleecy
ms.author: joanlee
ms.date: 12/06/2021
ms.topic: article
...
# PlayFab Multiplayer Servers Unreal plugin overview

> [!IMPORTANT]
> This feature is in **private preview** for limited, Microsoft managed partners.

The PlayFab Multiplayer Servers (GSDK) Unreal plugin is a Unreal C++ wrapper on top of a native PlayFab Multiplayer Servers C++ library created for the convenience of Unreal game developers.
