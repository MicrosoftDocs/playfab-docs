...
DirectPeerConnectivityOptions=<REPLACE ME with your connectivity options, in the form of an array of string. All options provided will be utilized. The default case corresponds to the following:>
