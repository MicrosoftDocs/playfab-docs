...
- First, let us save the **Licensing Key** (this will come in handy for linking PlayFab with **PlayMarket**.
...
- Select the **New Catalog** button **(3)**.
...
- Set the **Item ID (1)** to match exactly with the ID in **PlayMarket**.
