...
The pop-up window is similar to the one we have provided below. (Your list of items will match your title. The displayed items are described in our [Drop Tables](drop-tables.md) tutorial).
