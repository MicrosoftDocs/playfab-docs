...
Triggers, Conditions, and Actions are also part of other systems: [Bulk Actions](https://api.playfab.com/docs/tutorials/landing-automation/bulk-actions-for-an-entire-player-segment) and [Tournament Leaderboards](../../social/tournaments-leaderboards/using-resettable-statistics-and-leaderboards.md).
