...
The Dashboard allows you to configure, control and track many aspects of your game title's features, globally. It includes the Overview tab as well as the PlayStream Monitor tab for all the PlayStream functions.
