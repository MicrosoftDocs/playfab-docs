...
**How to access:** To view PlayFab documentation, see [../../index.yml](../../index.yml).
...
**How to access:** The PlayFab Discord Forums is accessible via a free Discord account. Start by following this invite to the Microsoft Game Dev Server and opting-in to the PlayFab channel during the onboarding flow: [https://discord.com/invite/msftgamedev](https://discord.com/invite/msftgamedev). 

**Move to Discord:** PlayFab moved its community forums from PlayFab.com to Discord on June 26, 2024. Read more about it here: [https://developer.microsoft.com/games/articles/2024/05/playfab-dev-forums-move-to-discord/](https://developer.microsoft.com/games/articles/2024/05/playfab-dev-forums-move-to-discord/) 
...
To learn more about upgrading to a paid account plan, see [account-upgrades.md](account-upgrades.md).
