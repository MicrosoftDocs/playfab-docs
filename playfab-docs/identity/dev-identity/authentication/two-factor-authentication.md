...
![Google - 2-Step Verification - Begin](media/google-2-step-verification-begin.png)  

Follow through the tutorial for the app, if there is any **(1)**.

![Google - 2-Step Verification - Info Screen](media/google-2-step-verification-info-screen.png)  
...
![Google - 2-Step Verification - Add account](media/google-2-step-verification-add-account.png)  
...
![Game Manager - Dashboard - Open My Profile](media/game-manager-dashboard-open-my-profile.png)  
...
![Game Manager - My Profile - Two-Factor Authentication](media/game-manager-my-profile-two-factor-authentication.png)  

Once this is done, you will obtain a two-factor code.

![Google - Authenticator - Confirm verification code](media/google-authenticator-confirm-verification-code.png)
...
![Game Manager - My Profile - Enter Two-factor code](media/game-manager-my-profile-enter-two-factor-code.png)
...
![PlayFab - Login Screen](media/playfab-login-screen.png)
...
![PlayFab - Enter Two-factor token](media/playfab-enter-two-factor-token.png)
