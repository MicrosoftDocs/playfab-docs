...
is being used we have a different meter for tracking this type of requests, learn more here: [Statistics meters](../../get-started/pricing/Meters/statistics-meters.md)
