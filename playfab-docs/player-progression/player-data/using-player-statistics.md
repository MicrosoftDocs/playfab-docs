...
- **Max** and **Min** can be used to save **best/worst** scores such as Headshots or Accuracy:
  ...
  - These can be very useful for [resettable leaderboards](../../community/associations/tournaments-leaderboards/using-resettable-statistics-and-leaderboards.md), as well as a [PlayStream Rule](https://playfab.com/introducing-playstream/) that grants achievements.
