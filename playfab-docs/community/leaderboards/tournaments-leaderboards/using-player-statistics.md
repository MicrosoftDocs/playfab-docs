...
Player statistics are also used by leaderboards, but this guide only covers player statistics exclusively. If you wish to read about how player statistics and leaderboards work *together*, read our tutorial [Using resettable statistics and leaderboards](using-resettable-statistics-and-leaderboards.md).
...
- At this point you should see the page shown below.
  ...
  ![PlayFab Leaderboards - Edit Leaderboard - Stat aggregation](../../../player-progression/player-data/media/tutorials/playfab-edit-leaderboard-stat-aggregation.png)  
...
- **Max** and **Min** can be used to save **best/worst** scores such as Headshots or Accuracy:
  ...
  - These can be very useful for [resettable leaderboards](using-resettable-statistics-and-leaderboards.md), as well as a [PlayStream Rule](https://playfab.com/introducing-playstream/) that grants achievements.
