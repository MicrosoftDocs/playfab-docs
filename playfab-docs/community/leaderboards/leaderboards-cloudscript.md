...
In this section we're going to create a simple leaderboard that will allow us to submit scores and retrieve the top scores. 
...
- Within the function, we set the PlayFab Title ID and Developer Secret Key to authenticate our requests to PlayFab services. You can change the way you want to access this values based on what fits best for your particular case and security requirements.
