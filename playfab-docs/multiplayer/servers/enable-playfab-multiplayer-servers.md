...
Certain servers have limited free usage and capacity limits. They can be used during evaluation and development. If you're enrolled in paid pricing plans, you may request for additional server cores. To learn more, see [Managing Server cores quota](quota-changes.md).
