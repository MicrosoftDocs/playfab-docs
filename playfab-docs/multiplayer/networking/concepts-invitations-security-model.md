...
A given PlayFab Party network can have a maximum of [128 players](/rest/api/playfab/multiplayer/multiplayer-server/request-party-service#partynetworkconfiguration). 
