...
This quickstart guide helps you integrate the [PlayFab SDK Unreal Engine (UE) Marketplace Plugin](../../sdks/unreal/index.md) into your existing PlayFab Online Subsystem (OSS) integrated project.
