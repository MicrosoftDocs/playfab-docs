...
Access to samples for Nintendo Switch, PlayStation&#174;4, PlayStation&#174;5, PC (GDK), and Xbox (GDK) requires special approval and adherence to platform policies. For more information, see [Request access for SDKs and samples](../../sdks/request-access-for-sdks-samples.md).
