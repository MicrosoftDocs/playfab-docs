...
In preparation for wider release of the service, we are rolling out PlayFab Multiplayer Servers 2.0 APIs. See [PlayFab Multiplayer Servers 2.0 (Thunderhead)](../multiplayer/servers/index.md) for more information
...
- [UnitySDK](https://github.com/PlayFab/UnitySDK)
  ...
  - New Feature - read our [Sessions](../miscellaneous/hold-topics/analytics/metrics/sessions.md) tutorial.
