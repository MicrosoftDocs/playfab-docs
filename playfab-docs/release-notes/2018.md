...
- [XPlatCppSdk](https://github.com/PlayFab/XPlatCppSdk)
  -**SDK Breaking Change** : Updated the folder structure for the ``XPlatCppSdk`` repo. If you're using the SDK with project references, an update to vcxproj files path would be required.
...
In preparation for wider release of the service, we're rolling out PlayFab Multiplayer Servers 2.0 APIs. See [PlayFab Multiplayer Servers 2.0 (Thunderhead)](../multiplayer/servers/index.md) for more information
...
- [client_focus_change](../api-references/events/Session/client-focus-change.md)
- [client_session_start](../api-references/events/Session/client-session-start.md)
...
- See our [Upgrade Guide](../live-service-management/game-configuration/entities/entity-api-restructure-upgrade-tutorial.md)!
...
- **New PlayStream Events**
  - `title_hopper_config_updated` event renamed to [title_queue_config_updated](../api-references/events/Matchmaking/title-queue-config-updated.md)
- **General changes**
...
- [UnitySDK](https://github.com/PlayFab/UnitySDK)
  ...
  - New Feature - read our [Sessions](../data-analytics/ingest-data/sessions.md) tutorial.
...
- New PlayStream Event:
  - [player_data_exported](../api-references/events/PlayerIdentity/player-data-exported.md)
...
- **New PlayStream Events:**
  - [entity_executed_cloud_script](../api-references/events/CloudScript/entity-executed-cloud-script.md)
- **Updated API Method:**
...
- Entities! [Blog](https://api.playfab.com/blog/introducing-entities-objects-and-files)! [Quickstart Guide](../live-service-management/game-configuration/entities/quickstart.md)!
- All Client login methods return Entity credentials if `request.LoginTitlePlayerAccountEntity` is set to `true`.
- Guilds! [Blog](https://api.playfab.com/blog/announcing-groups-for-guilds-friends-clans-and-more)! [Guide](../community/associations/groups/quickstart.md)!
...
- A whole new [Entity API](../live-service-management/game-configuration/entities/quickstart.md).
