...
See https://aka.ms/PlayFabMultiplayer for more information
...
### API Changes:
 ...
 - [SendAccountRecoveryEmail](https://docs.microsoft.com/rest/api/playfab/client/account-management/sendaccountrecoveryemail?view=playfab-rest) now supports custom account recovery email templates when a custom account recovery email template ID is passed in with the request parameters.
