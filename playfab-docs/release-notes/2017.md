...
* A virtual currency property has been removed from API methods that use "[ProfileModel](https://api.playfab.com/documentation/client/datatype/playfab.client.models/PlayFab.Client.Models.PlayerProfileModel)", as that information was never actually provided or correct. It will return... someday.

**New API Methods:**

* admin.[CheckLimitedEditionItemAvailability](https://api.playfab.com/documentation/admin/method/CheckLimitedEditionItemAvailability)
* admin.[IncrementLimitedEditionItemAvailability](https://api.playfab.com/documentation/admin/method/IncrementLimitedEditionItemAvailability)
* client.[GetPaymentToken](https://api.playfab.com/documentation/client/method/GetPaymentToken)
  * Used for [XSolla specific payment processing](https://api.playfab.com/docs/tutorials/landing-commerce/non-receipt-payment-processing)
* client.[ReportDeviceInfo](https://api.playfab.com/documentation/client/method/ReportDeviceInfo)
 ...
 * client.[AddOrUpdateContactEmail](https://api.playfab.com/documentation/client/method/AddOrUpdateContactEmail)
 * client.[GetLeaderboardAroundPlayer](https://api.playfab.com/documentation/client/method/GetLeaderboardAroundPlayer)
 * client.[LoginWithAndroidDeviceID](https://api.playfab.com/documentation/client/method/LoginWithAndroidDeviceID)
 * client.[LoginWithCustomID](https://api.playfab.com/documentation/client/method/LoginWithCustomID)
 * client.[LoginWithIOSDeviceID](https://api.playfab.com/documentation/client/method/LoginWithIOSDeviceID)
 ...
 * [CocosSDK](https://github.com/PlayFab/CocosSDK): We are still targeting 3.15.1, despite 3.16 Cocos release (stay tuned)
...
* admin.[GetPlayerProfile](https://api.playfab.com/documentation/admin/method/GetPlayerProfile)
* server.[SendEmailFromTemplate](https://api.playfab.com/documentation/server/method/SendEmailFromTemplate)
...
* admin.[ResetPassword](https://api.playfab.com/documentation/admin/method/ResetPassword)
* admin.[GetPlayerIdFromAuthToken](https://api.playfab.com/documentation/admin/method/GetPlayerIdFromAuthToken)
* client.[AddOrUpdateContactEmail](https://api.playfab.com/documentation/client/method/AddOrUpdateContactEmail)
* client.[RemoveContactEmail](https://api.playfab.com/documentation/client/method/RemoveContactEmail)
* server.[SendCustomAccountRecoveryEmail](https://api.playfab.com/documentation/server/method/SendCustomAccountRecoveryEmail)

**Documentation Update:**

* [New list of error codes relevant to every PlayFab API call](https://api.playfab.com/docs/tutorials/globalcodes)
* Updated Error Codes for: client.[LoginWithGoogleAccount](https://api.playfab.com/documentation/client/method/LoginWithGoogleAccount), client.[UpdatePlayerStatistics](https://api.playfab.com/documentation/client/method/UpdatePlayerStatistics), server.[ConsumeItem](https://api.playfab.com/documentation/server/method/ConsumeItem)
...
* **New API Methods:**
 * admin.[DeleteTitle](https://api.playfab.com/documentation/admin/method/DeleteTitle)
 ...
 * All API methods that return server addresses now return both options: client.[StartGame](https://api.playfab.com/documentation/client/method/StartGame).[StartGameResult](https://api.playfab.com/documentation/client/datatype/PlayFab.client.Models/PlayFab.client.Models.StartGameResult)
...
* Added a parameter to server.[SendPushNotification](https://api.playfab.com/documentation/server/method/SendPushNotification).[SendPushNotificationRequest](https://api.playfab.com/documentation/server/datatype/PlayFab.server.Models/PlayFab.server.Models.SendPushNotificationRequest).[PushNotificationPackage](https://api.playfab.com/documentation/Server/datatype/PlayFab.Server.Models/PlayFab.Server.Models.PushNotificationPackage), for iOS Badge
...
* Our SDK now integrates with [Phaser.io](http://phaser.io/)
* Read our [guide](https://api.playfab.com/docs/tutorials/landing-players/phaser)!
...
**[UnrealCppSdk](https://github.com/PlayFab/UnrealCppSdk) Specific Changes:**
...
* client.[GetCurrentGames](https://api.playfab.com/documentation/client/method/GetCurrentGames).[result](https://api.playfab.com/documentation/client/datatype/PlayFab.client.Models/PlayFab.client.Models.CurrentGamesResult).Games[i].GameServerState has been deprecated and replaced with [GameServerStateEnum](https://api.playfab.com/documentation/Client/datatype/PlayFab.Client.Models/PlayFab.Client.Models.GameInstanceState)
...
* The following API methods have been deprecated:
  ...
  * [GetActionsOnPlayersInSegmentTaskInstance](https://api.playfab.com/documentation/admin/method/GetActionsOnPlayersInSegmentTaskInstance) - This has accidentally been labeled as deprecated, but that was an error which will be reverted
* [SendPushNotification](https://api.playfab.com/documentation/server/method/SendPushNotification) can now specify [TargetPlatforms](https://api.playfab.com/documentation/server/datatype/PlayFab.server.Models/PlayFab.server.Models.SendPushNotificationRequest)
 * Added some clarifications for which parameters work on which platforms for [SendPushNotificationRequest](https://api.playfab.com/documentation/server/datatype/PlayFab.server.Models/PlayFab.server.Models.SendPushNotificationRequest) (Using parameters not supported for a target platform is not recommended)
* Added some info about [Shared Group](https://api.playfab.com/documentation/client/method/CreateSharedGroup) [restrictions](https://api.playfab.com/docs/tutorials/landing-players/shared-groups) to the Shared Group documentation (specifically that they can't be used for anything like Guilds)
* [Player Profiles](https://api.playfab.com/documentation/Client/datatype/PlayFab.Client.Models/PlayFab.Client.Models.PlayerProfileModel) can now store a player [contact email address](https://api.playfab.com/documentation/Client/datatype/PlayFab.Client.Models/PlayFab.Client.Models.ContactEmailInfoModel).
...
* server.[GetFriendsList](https://api.playfab.com/documentation/server/method/GetFriendsList) and client.[GetFriendsList](https://api.playfab.com/documentation/client/method/GetFriendsList) API methods now return a [PlayerProfile](https://api.playfab.com/documentation/Client/datatype/PlayFab.Client.Models/PlayFab.Client.Models.PlayerProfileModel) for each of your friends.
...
* admin.[DeletePlayer](https://api.playfab.com/documentation/admin/method/DeletePlayer)

** Deprecated API Methods:**

* These API methods never worked as fully and completely as they were supposed to. In an effort to clean this up, we've started over, and built the new "[DeletePlayer](https://api.playfab.com/documentation/admin/method/DeletePlayer)" API above, and these are deprecated:
...
* PlayerProfile (in [Admin](https://api.playfab.com/documentation/Server/datatype/PlayFab.Admin.Models/PlayFab.Admin.Models.PlayerProfile)/[Server](https://api.playfab.com/documentation/Server/datatype/PlayFab.Server.Models/PlayFab.Server.Models.PlayerProfile)/[PlayStream](https://api.playfab.com/playstream/profile/PlayerProfile)) contains a new field "ContactEmailAddresses" which contains any email address info you may have saved about your players
...
**[LumberyardSdk](https://github.com/PlayFab/LumberyardSdk) Changes:**

* **UPGRADE WARNING:** This SDK is no longer compatible with previous versions of Lumberyard.
* This release of PlayFab [LumberyardSdk](https://api.playfab.com/sdks/lumberyard) no longer works with Lumberyard version 1.3. It has been upgraded and now targets Lumberyard 1.9. We will very likely have it targeting 1.10 in the near future, but again without backwards compatibility to 1.9 or earlier. See [our blog](https://blog.playfab.com/blog/cpp-sdk-updates) for details.

**[UnrealCppSdk](https://github.com/PlayFab/UnrealCppSdk):**

* This SDK has been discontinued, and will no longer be maintained. We will produce an upgrade guide so that users can switch to the [UnrealBlueprintSdk](https://github.com/PlayFab/UnrealBlueprintSdk). Please see this blog for more details.
* See our [upgrade guide](https://github.com/PlayFab/UnrealBlueprintSDK/blob/master/UnrealCppSdkUpgradeGuide.md)

**Unreal SDK:**

* The PlayFab [UnrealBlueprintSdk](https://github.com/PlayFab/UnrealBlueprintSdk) is now rebranded as the "Unreal SDK"
 ...
 * **New API methods:**
   * admin.[CreatePlayerSharedSecret](https://api.playfab.com/documentation/admin/method/CreatePlayerSharedSecret)
   * admin.[DeletePlayerSharedSecret](https://api.playfab.com/documentation/admin/method/DeletePlayerSharedSecret)
   * admin.[GetPlayerSharedSecrets](https://api.playfab.com/documentation/admin/method/GetPlayerSharedSecrets)
   * admin.[SetPlayerSecret](https://api.playfab.com/documentation/admin/method/SetPlayerSecret)
   * admin.[UpdatePlayerSharedSecret](https://api.playfab.com/documentation/admin/method/UpdatePlayerSharedSecret)
   * client.[GetTitlePublicKey](https://api.playfab.com/documentation/client/method/GetTitlePublicKey)
   * client.[SetPlayerSecret](https://api.playfab.com/documentation/client/method/SetPlayerSecret)
   * server.[SetPlayerSecret](https://api.playfab.com/documentation/server/method/SetPlayerSecret)
* server.[RegisterGameRequest](https://api.playfab.com/documentation/Server/datatype/PlayFab.Server.Models/PlayFab.Server.Models.RegisterGameRequest) has a new property: LobbyId, which will let you attempt to re-register an existing game
* server.[SendPushNotificationRequest](https://api.playfab.com/documentation/Server/datatype/PlayFab.Server.Models/PlayFab.Server.Models.SendPushNotificationRequest) now accepts a new property: Package, which defines all of the advanced Android push capabilities.

**SDK Breaking Change:**

* admin.[SetupPushNotificationRequest](https://api.playfab.com/documentation/Admin/datatype/PlayFab.Admin.Models/PlayFab.Admin.Models.SetupPushNotificationRequest).Platform is now defined as an enum instead of a string.  This is not a breaking change to the API (as enums are transmitted as strings), but it will require some users to convert their strings to the enum values in their code.
...
* [CocosSDK](https://github.com/PlayFab/CocosSDK) built, and tested with Cocos 3.15.1
...
* **BREAKING CHANGE:** In server.[ReportPlayer](https://api.playfab.com/documentation/server/method/ReportPlayer), [ReportPlayerServerRequest](https://api.playfab.com/documentation/Server/datatype/PlayFab.Server.Models/PlayFab.Server.Models.ReportPlayerServerRequest).titleId has been immediately removed (not merely deprecated).  All reports will now go to their own title, and cannot report to another title
...
* In client.[ReportPlayer](https://api.playfab.com/documentation/client/method/ReportPlayer) and server.[ReportPlayer](https://api.playfab.com/documentation/server/method/ReportPlayer), result.Updated has been deprecated in both cases.  It was always true, and the API Call would always return an error if the Player was over the report limit.  This error condition has been updated to be OverLimit to match other limits.
* All [login methods](https://api.playfab.com/documentation/Client#Authentication) can now return a [player profile object](https://api.playfab.com/documentation/Client/datatype/PlayFab.Client.Models/PlayFab.Client.Models.PlayerProfileModel), if requested, which contains information previously only available to leaderboard results

**New API methods:**

* client.[GetPlayerProfile](https://api.playfab.com/documentation/client/method/GetPlayerProfile) and server.[GetPlayerProfile](https://api.playfab.com/documentation/server/method/GetPlayerProfile)
...
* [ExecuteCloudScript](https://api.playfab.com/documentation/client/method/ExecuteCloudScript) return and log size limits defined
...
* [New/Updated Guide](https://api.playfab.com/docs/tutorials/landing-players/push-notification-basics/push-notifications-for-android)
...
* **BREAKING CHANGE:** [ExecuteCloudScript](https://api.playfab.com/documentation/client/method/ExecuteCloudScript) will not serialize the return value of your call, if it is too large.
* **BREAKING CHANGE:** [ExecuteCloudScript](https://api.playfab.com/documentation/client/method/ExecuteCloudScript) will not serialize the logs for your call, if they are too large.
...
* **[UnrealCppSdk](https://github.com/PlayFab/UnrealCppSdk) Updates:**
...
* See: [UpdatePolicy](https://api.playfab.com/documentation/admin/method/UpdatePolicy) , specifically [UpdatePolicyRequest](https://api.playfab.com/documentation/admin/datatype/playfab.admin.models/PlayFab.Admin.Models.UpdatePolicyRequest).[Statements](https://api.playfab.com/documentation/Admin/datatype/PlayFab.Admin.Models/PlayFab.Admin.Models.PermissionStatement).[ApiConditions](https://api.playfab.com/documentation/Admin/datatype/PlayFab.Admin.Models/PlayFab.Admin.Models.ApiCondition)
...
* **Client & Server Leaderboard Methods:** Get-Leaderboard methods (such as client.[GetLeaderboard](https://api.playfab.com/documentation/client/method/GetLeaderboard)) previously gained new non-nullable parameters Version and UseSpecificVersion.  The requirement that they were non-nullable was an API-breaking change.  We have updated these properties to be fully optional.
* **Client API:** [GetPurchaseResult](https://api.playfab.com/documentation/client/datatype/playfab.client.models/PlayFab.Client.Models.GetPurchaseResult).Items will be deprecated: This portion of the result is often incorrect or incomplete.  It will eventually be replaced with a fully functional parameter.
...
* [UnrealCppSdk](https://github.com/PlayFab/UnrealCppSdk): An issue where PlayFab settings such as TitleId were lost when publishing a build has been fixed.
...
* Leaderboard entries now contain the [PlayerProfile](https://api.playfab.com/playstream/profile/PlayerProfile) which can be used to display more detailed leaderboards without additional API calls
* PlayFab can now authenticate clients using Windows Hello and validate Windows Store receipts

**New APIs:**

* [Client/UpdateAvatarUrl](https://api.playfab.com/documentation/Client/method/UpdateAvatarUrl)
* [Client/RegisterWithWindowsHello](https://api.playfab.com/documentation/Client/method/RegisterWithWindowsHello)
* [Client/GetWindowsHelloChallenge](https://api.playfab.com/documentation/Client/method/GetWindowsHelloChallenge)
* [Client/LoginWithWindowsHello](https://api.playfab.com/documentation/Client/method/LoginWithWindowsHello)
* [Client/LinkWindowsHello](https://api.playfab.com/documentation/Client/method/LinkWindowsHello)
* [Client/UnlinkWindowsHello](https://api.playfab.com/documentation/Client/method/UnlinkWindowsHello)
* [Client/ValidateWindowsStoreReceipt](https://api.playfab.com/documentation/Client/method/ValidateWindowsStoreReceipt)
* [Server/SetFriendTags](https://api.playfab.com/documentation/Server/method/SetFriendTags)
...
* See [our blog](https://playfab.com/blog/typescript/)!
...
* Repeating a note from [160627](https://api.playfab.com/releaseNotes/#160627), UnityEngine.SimpleJson is an empty namespace in the UnityEngine.dll, and that makes it necessary for us to not use that identifier.
...
* [New Getting Started Guides](https://playfab.com/blog/sdkgettingstarted/)
...
* Blog Post: https://playfab.com/blog/windowssdk-update-released/
* Upgrade Guide: https://github.com/PlayFab/WindowsSdk/blob/master/UpgradeGuide.md
