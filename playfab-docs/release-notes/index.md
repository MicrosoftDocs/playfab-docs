 ...
 * When TitleId is not set, API methods now throws real-time exceptions synchronously, rather than reporting the issue in an synchronous or threaded callbacks
