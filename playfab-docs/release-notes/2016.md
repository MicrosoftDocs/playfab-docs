...
* See our [blog post](https://playfab.com/blog/permission-policies/) for details
...
* [Admin/GetPolicy](https://api.playfab.com/documentation/Admin/method/GetPolicy)
* [Admin/UpdatePolicy](https://api.playfab.com/documentation/Admin/method/UpdatePolicy)
* Scheduled Tasks
* [Admin/AbortTaskInstance](https://api.playfab.com/documentation/Admin/method/AbortTaskInstance)
* [Admin/CreateActionsOnPlayersInSegmentTask](https://api.playfab.com/documentation/Admin/method/CreateActionsOnPlayersInSegmentTask)
* [Admin/CreateCloudScriptTask](https://api.playfab.com/documentation/Admin/method/CreateCloudScriptTask)
* [Admin/DeleteTask](https://api.playfab.com/documentation/Admin/method/DeleteTask)
* [Admin/GetActionsOnPlayersInSegmentTaskInstance](https://api.playfab.com/documentation/Admin/method/GetActionsOnPlayersInSegmentTaskInstance)
* [Admin/GetCloudScriptTaskInstance](https://api.playfab.com/documentation/Admin/method/GetCloudScriptTaskInstance)
* [Admin/GetTasks](https://api.playfab.com/documentation/Admin/method/GetTasks)
* [Admin/RunTask](https://api.playfab.com/documentation/Admin/method/RunTask)
* [Admin/UpdateTask](https://api.playfab.com/documentation/Admin/method/UpdateTask)
...
* A new overhauled [WindowsSDK](https://github.com/PlayFab/WindowsSDK) will be published next week
...
* [CSharpSDK](https://github.com/PlayFab/CSharpSDK) Specific Changes:
  * [Major CSharp upgrade](https://playfab.com/blog/csharpsdk-upgrade/)
...
* Client/GetUserCombinedInfo has transitioned from Proposed to Deprecated, which means most SDKs using this will now throw an error. Please transition to [Client/GetPlayerCombinedInfo](https://api.playfab.com/documentation/Client/method/GetPlayerCombinedInfo)
* Deprecated APIs from this patch note: [160822](https://api.playfab.com/releaseNotes/#160822) have transitioned from deprecated to obsolete, according to this blog: [Deprecation Visibility](https://playfab.com/blog/deprecation-visibility/) and thus, those APIs have been removed from the newest version of the SDKs. If you update your SDK, you must now transition to the new replacement APIs
...
* The default helloWorld Cloud Script function described in this doc: [Using Cloud Script](https://api.playfab.com/docs/tutorials/landing-automation/using-cloud-script) was out of date. Updated the document to more closely match the current version (This is only relevant to new title creation)

**API Server Bugfixes:**

* Fixed a 500 error in [Server/ExecuteCloudScript](https://api.playfab.com/documentation/Server/method/ExecuteCloudScript): PlayFabId is now a mandatory parameter (Formerly it would error if it wasn't provided)
* Fixed a 500 error in [Server/GetSharedGroupData](https://api.playfab.com/documentation/Server/method/GetSharedGroupData): SharedGroupId is now a mandatory parameter (Formerly it would error if it wasn't provided)
* Fixed a 500 error in [Server/AddSharedGroupMembers](https://api.playfab.com/documentation/Server/method/AddSharedGroupMembers): PlayFabIds is now a mandatory parameter (Formerly it would error if it wasn't provided)
* Fixed a 500 error in [Server/RemoveSharedGroupMembers](https://api.playfab.com/documentation/Server/method/RemoveSharedGroupMembers): PlayFabIds is now a mandatory parameter (Formerly it would error if it wasn't provided)
* Fixed a 500 error in [Server/DeleteSharedGroup](https://api.playfab.com/documentation/Server/method/DeleteSharedGroup): SharedGroupId is now a mandatory parameter (Formerly it would error if it wasn't provided)
...
* Improved search results on our documentation site: https://api.playfab.com/
 ...
 * [Admin/RefundPurchase](https://api.playfab.com/documentation/Admin/method/RefundPurchase)
 * [Admin/ResolvePurchaseDispute](https://api.playfab.com/documentation/Admin/method/ResolvePurchaseDispute)

**A few friend-based APIs have been copied from the Client to the Server:**

* [Server/GetFriendLeaderboard](https://api.playfab.com/documentation/Server/method/GetFriendLeaderboard)
* [Server/AddFriend](https://api.playfab.com/documentation/Server/method/AddFriend)
* [Server/GetFriendsList](https://api.playfab.com/documentation/Server/method/GetFriendsList)
* [Server/RemoveFriend](https://api.playfab.com/documentation/Server/method/RemoveFriend)

**Small improvements to the Matchmaking ability of our Server API:**

* [Server/RegisterGame](https://api.playfab.com/documentation/Server/method/RegisterGame)
* [Server/DeregisterGame](https://api.playfab.com/documentation/Server/method/DeregisterGame)
* [Server/SetGameServerInstanceTags](https://api.playfab.com/documentation/Server/method/SetGameServerInstanceTags)
* [Server/RefreshGameServerInstanceHeartbeat](https://api.playfab.com/documentation/Server/method/RefreshGameServerInstanceHeartbeat)
...
* The deprecation warnings described [below](https://api.playfab.com/releaseNotes/#160822) have gone into effect. Deprecated APIs will now throw compiler errors when possible.
...
* **New APIs:**
  * [Client/GetPlayerTags](https://api.playfab.com/documentation/Client/method/GetPlayerTags)
  * [Server/AddPlayerTag](https://api.playfab.com/documentation/Server/method/AddPlayerTag)
  * [Server/GetPlayerTags](https://api.playfab.com/documentation/Server/method/GetPlayerTags)
  * [Server/RemovePlayerTag](https://api.playfab.com/documentation/Server/method/RemovePlayerTag)
  * [Admin/AddPlayerTag](https://api.playfab.com/documentation/Admin/method/AddPlayerTag)
  * [Admin/GetPlayerTags](https://api.playfab.com/documentation/Admin/method/GetPlayerTags)
  * [Admin/RemovePlayerTag](https://api.playfab.com/documentation/Admin/method/RemovePlayerTag)<br>
...
There is a blog post about this [here](https://playfab.com/blog/deprecation-visibility/).
...
* **New APIs:**
 * [Admin/BanUsers](https://api.playfab.com/documentation/Admin/method/BanUsers)
 * [Admin/GetUserBans](https://api.playfab.com/documentation/Admin/method/GetUserBans)
 * [Admin/RevokeAllBansForUser](https://api.playfab.com/documentation/Admin/method/RevokeAllBansForUser)
 * [Admin/RevokeBans](https://api.playfab.com/documentation/Admin/method/RevokeBans)
 * [Admin/UpdateBans](https://api.playfab.com/documentation/Admin/method/UpdateBans)
 * [Admin/DeleteStore](https://api.playfab.com/documentation/Admin/method/DeleteStore)
 * [Server/BanUsers](https://api.playfab.com/documentation/Server/method/BanUsers)
 * [Server/GetUserBans](https://api.playfab.com/documentation/Server/method/GetUserBans)
 * [Server/RevokeAllBansForUser](https://api.playfab.com/documentation/Server/method/RevokeAllBansForUser)
 * [Server/RevokeBans](https://api.playfab.com/documentation/Server/method/RevokeBans)
 * [Server/UpdateBans](https://api.playfab.com/documentation/Server/method/UpdateBans)
 * [Server/GetRandomResultTables](https://api.playfab.com/documentation/Server/method/GetRandomResultTables)
* **New PlayStream events:**
...
**[UnrealCppSdk](https://github.com/PlayFab/UnrealCppSdk) & [UnrealBlueprintSdk](https://github.com/PlayFab/UnrealBlueprintSdk) Specific Changes:**
...
* **New APIs:**
 * [RemoveVirtualCurrencyTypes](https://api.playfab.com/documentation/Admin/method/RemoveVirtualCurrencyTypes)
 * [GetAllSegments](https://api.playfab.com/documentation/Admin/method/GetAllSegments)
 * [GetPlayerSegments](https://api.playfab.com/documentation/Admin/method/GetPlayerSegments)
 * [GetPlayersInSegment](https://api.playfab.com/documentation/Admin/method/GetPlayersInSegment)
 * [GetPlayerCombinedInfo](https://api.playfab.com/documentation/Server/method/GetPlayerCombinedInfo)
 * [GetAllSegments](https://api.playfab.com/documentation/Server/method/GetAllSegments)
 * [GetPlayerSegments](https://api.playfab.com/documentation/Server/method/GetPlayerSegments)
 * [GetPlayersInSegment](https://api.playfab.com/documentation/Server/method/GetPlayersInSegment)
* **New PlayStream Events:**
...
* We have released a new major revision for [UnitySdk](https://github.com/PlayFab/UnitySDK). Please visit our [Upgrade Guide](https://github.com/PlayFab/UnitySDK/blob/master/UPGRADE.md).

**API Changes:**

* You can now set CustomData on an item when granting it via the Admin Api: [GrantItemsToUsers](https://api.playfab.com/documentation/Admin/method/GrantItemsToUsers), specifically: [ItemGrant](https://api.playfab.com/documentation/Admin/datatype/PlayFab.Admin.Models/PlayFab.Admin.Models.ItemGrant)
* **Twitch login integration! and APIs:**
 * [LoginWithTwitch](https://api.playfab.com/documentation/Client/method/LoginWithTwitch)
 * [LinkTwitch](https://api.playfab.com/documentation/Client/method/LinkTwitch)
 * [UnlinkTwitch](https://api.playfab.com/documentation/Client/method/UnlinkTwitch)
 * [GetPlayFabIDsFromTwitchIDs](https://api.playfab.com/documentation/Client/method/GetPlayFabIDsFromTwitchIDs)
* **New PlayStream Events:**
...
**[LumberyardSdk](https://github.com/PlayFab/LumberyardSdk) Specific Changes:**

* Updated to [Lumberyard 1.3](https://aws.amazon.com/blogs/gametech/vr-hdr-and-more-in-lumberyard-beta-1-3-available-now/)
...
* **New API:**
 * [GetPlayerCombinedInfo](https://api.playfab.com/documentation/Client/method/GetPlayerCombinedInfo)
* Lots of updated descriptions.
* All login calls have been updated to optionally return the [GetPlayerCombinedInfo](https://api.playfab.com/documentation/Client/datatype/PlayFab.Client.Models/PlayFab.Client.Models.GetPlayerCombinedInfoResultPayload) results.
* GetUserCombinedInfo API will be deprecated in favor of [GetPlayerCombinedInfo](https://api.playfab.com/documentation/Client/method/GetPlayerCombinedInfo) in the near future.
...
* **New Admin APIs:**
 * [GetTitleInternalData](https://api.playfab.com/documentation/Admin/method/GetTitleInternalData)
 * [SetTitleInternalData](https://api.playfab.com/documentation/Admin/method/SetTitleInternalData)
* **New PlayStream events:**
...
* **New API:**
 * [SetGameServerInstanceData](https://api.playfab.com/documentation/Server/method/SetGameServerInstanceData)
* **Bugfix for APIs:**
 * [Server/SetGameServerInstanceState](https://api.playfab.com/documentation/Server/method/SetGameServerInstanceState)
 * [Client/GetCurrentGames](https://api.playfab.com/documentation/Client/method/GetCurrentGames)

**SDK Global Changes:**

* Please note that RunCloudScript has been deprecated since March 2016, and will be removed from the sdks in the near future. Please convert to [ExecuteCloudScript](https://api.playfab.com/documentation/Client/method/ExecuteCloudScript) asap.
...
* All testing and examples for Cloud Script have been updated to [ExecuteCloudScript](https://api.playfab.com/documentation/Client/method/ExecuteCloudScript), since RunCloudScript is deprecated.
...
* More steps towards the deprecation of RunCloudScript, so customers should plan to migrate to [ExecuteCloudScript](https://api.playfab.com/documentation/Client/method/ExecuteCloudScript) for live projects.
...
* New Admin API:
 * [SetStoreSegmentOverrides](https://api.playfab.com/documentation/Admin/method/SetStoreSegmentOverrides)
...
**[UnrealBlueprintSdk](https://github.com/PlayFab/UnrealBlueprintSdk) Upgrade warning:** Many blueprint-api-calls which have enum fields will have to be updated to utilize the enum dropdown. The old value will be lost, and must be re-set. This affects dozens of PlayFab blueprint nodes.
...
* New server API:
 * [EvaluateRandomResultTable](https://api.playfab.com/documentation/Server/method/EvaluateRandomResultTable)
...
* [UnrealBlueprintSdk](https://github.com/PlayFab/UnrealBlueprintSdk) is nearing the end of its limited-support Beta period. As such, there will be some potentially breaking changes in the next few releases.
* There are data fields in the Api-specification defined as enums. Formerly, [UnrealBlueprintSdk](https://github.com/PlayFab/UnrealBlueprintSdk) displayed these fields as arbitrary strings, and the user was expected to input the correct option. This has been fixed. All these fields have been converted to be enum-dropdowns in the blueprints.
...
**[CocosSDK](https://github.com/PlayFab/CocosSDK) Specific Changes**
...
* Amazon's [LumberyardSdk](https://github.com/PlayFab/LumberyardSdk) now available!
...
**[CocosSDK](https://github.com/PlayFab/CocosSDK) & [WindowsSDK](https://github.com/PlayFab/WindowsSDK)/C++ Specific Changes**

* Updated both to use RapidJson 1.0.2 (C++ syntax and code where relevant)
* Some other fixes, including IOS
* courtesy of http://mingle-games.com/
