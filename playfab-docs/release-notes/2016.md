...
- **New PlayStream events:**
  ...
  - The default `helloWorld` CloudScript function described in this doc: [CloudScript quickstart](/playfab-docs/live-service-management/service-gateway/automation/cloudscript/quickstart.md) was out of date. Updated the document to more closely match the current version (This is only relevant to new title creation)
