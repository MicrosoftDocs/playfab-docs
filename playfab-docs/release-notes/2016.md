...
* The default helloWorld Cloud Script function described in this doc: [Cloud Script Quickstart](../features/automation/cloudscript/cloudscript-quickstart.md) was out of date. Updated the document to more closely match the current version (This is only relevant to new title creation)
