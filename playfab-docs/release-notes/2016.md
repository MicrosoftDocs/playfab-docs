...
* Deprecated APIs from this patch note: [160822](https://api.playfab.com/releaseNotes/#160822) have transitioned from deprecated to obsolete, according to this blog: [Deprecation Visibility](https://blog.playfab.com/blog/deprecation-visibility/) and thus, those APIs have been removed from the newest version of the SDKs. If you update your SDK, you must now transition to the new replacement APIs
