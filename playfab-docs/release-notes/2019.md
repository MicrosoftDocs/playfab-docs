...
* New methods: [GetMultiplayerServerLogs](https://docs.microsoft.com/en-us/rest/api/playfab/multiplayer/multiplayerserver/getmultiplayerserverlogs?view=playfab-rest) and [UntagContainerImage](https://docs.microsoft.com/en-us/rest/api/playfab/multiplayer/multiplayerserver/untagcontainerimage?view=playfab-rest)
...
* Error situations throw error() objects instead of plain strings
