...
### API Changes:
 - [TreatmentAssignment](https://docs.microsoft.com/en-us/rest/api/playfab/client/authentication/loginwithandroiddeviceid?view=playfab-rest#treatmentassignment) used in the client "Login With ..." method calls.
...
### API Changes:
 ...
 - [Authentication API]https://docs.microsoft.com/en-us/rest/api/playfab/authentication/authentication?view=playfab-rest) has a new LoginIdentityProvider
 - Add CatalogVersion param to receipt validation APIs
 - PurchaseReceiptFulfillment - Receipt validation APIs return fulfilled items  example [Restore IOS Purchases](https://docs.microsoft.com/en-us/rest/api/playfab/client/platform-specific-methods/restoreiospurchases?view=playfab-rest#purchasereceiptfulfillment)
...
### API Changes:
 ...
 - [Multiplayer APIs](https://docs.microsoft.com/en-us/rest/api/playfab/multiplayer/multiplayerserver?view=playfab-rest) have moved out of Beta to CSharpOnly
...
### API Changes:
 ...
 - minor API changes
 - [Authentication](https://docs.microsoft.com/en-us/rest/api/playfab/authentication/authentication?view=playfab-rest) bug fixes
...
### API Changes:
 ...
 - Updated Error codes for the following APIs in the [PlayFab API](https://docs.microsoft.com/en-us/gaming/playfab/api-references/?view=playfab-rest): **Admin**, **Authentication**, **CloudScript**, **Groups**, **Matchmaker**, and **Multiplayer**.

## 190410

Date: 2019-04-10

### [Profiles](https://docs.microsoft.com/en-us/rest/api/playfab/profiles/account-management?view=playfab-rests) API Changes:

 - [EntityStatisticValue](https://docs.microsoft.com/en-us/rest/api/playfab/profiles/account-management/getprofiles?view=playfab-rest#entitystatisticvalue)
 - [EntityStatisticChildValue](https://docs.microsoft.com/en-us/rest/api/playfab/profiles/account-management/getprofiles?view=playfab-rest#entitystatisticchildvalue)
...
### API Changes:
 ...
 - New [Multiplayer]https://docs.microsoft.com/en-us/rest/api/playfab/multiplayer/multiplayerserver?view=playfab-rest) APIs
...
### API Changes:
  ...
  - Added AddLocalizedNews to the [Admin](https://docs.microsoft.com/en-us/gaming/playfab/api-references/?view=playfab-rest) API
  - Added GetPlayFabIDsFromPSNAccountIDs to the [Server](https://docs.microsoft.com/en-us/gaming/playfab/api-references/?view=playfab-rest) API
...
### API Changes:
 ...
 - Added **CurrentServerStats** to [Multiplayer](https://docs.microsoft.com/en-us/rest/api/playfab/multiplayer/multiplayerserver?view=playfab-rest) Models
