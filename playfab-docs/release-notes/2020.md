 ...
 * [Multiplayer Server](/gaming/playfab/multiplayer/):
...
* New feature and methods:
    ...
    * [Feature Documentation](../live-service-management/service-gateway/automation/cloudscript-af/index.md)
    * List of New Methods:
...
Dynamic Standby is an advanced game server feature and editing the settings from its default values should be done with caution. Configuring Dynamic Standby can be accomplished in the Game Manager Developers' portal or programmatically editing properties of the Dynamic Standby object. To learn more about Dynamic Standby, visit its user guide in the [PlayFab Multiplayer Servers](../multiplayer/servers/dynamic-standby.md) online documentation.
