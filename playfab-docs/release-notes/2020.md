 ...
 * [Insights](../index.yml#pivot=documentation&panel=insights):
    * Please see our new [Insights](https://docs.microsoft.com/gaming/playfab/features/insights/) feature!
 ...
 * [Authentication](../index.yml#pivot=documentation&panel=authentication):
    * Added new [LoginIdentityProviders](../api-references/events/data-types/loginidentityprovider.md) for Apple and Nintendo
 * [Multiplayer Server](../index.yml#pivot=documentation&panel=multiplayer):
...
* PlayFab API Documentation site has been fully migrated to [/gaming/playfab](https://docs.microsoft.com/gaming/playfab/)
