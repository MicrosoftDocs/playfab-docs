...
To distinguish between Multiplayer Server events of V1 and V2 format, examine the namespace property of the event.  The namespace is specified in the third column of the table above.  The JSON representation resembles the following:
