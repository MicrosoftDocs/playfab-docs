---
title: apikey_deactivated
author: ronnyparedes
description: apikey_deactivated event.
...
|Payload|[APIKeyDeactivatedPayload](../data-types/apikeydeactivatedpayload.md)|The payload of this event.|
