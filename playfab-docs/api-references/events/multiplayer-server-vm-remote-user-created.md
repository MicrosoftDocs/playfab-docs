...
|Payload|[MultiplayerServerVmRemoteUserCreatedEventPayload](data-types/multiplayerservervmremoteusercreatedeventpayload.md)|The multiplayer server virtual machine remote user created event payload.|
