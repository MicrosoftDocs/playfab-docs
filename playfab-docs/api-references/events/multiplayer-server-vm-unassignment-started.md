---
title: multiplayer_server_vm_unassignment_started
author: joannaleecy
description: multiplayer_server_vm_unassignment_started event.
ms.author: joanlee
ms.date: 02/19/2019
ms.topic: article
...
|Payload|[MultiplayerServerVmUnassignmentStartedEventPayload](data-types/multiplayerservervmunassignmentstartedeventpayload.md)|The multiplayer server virtual machine unassignment started event payload.|
