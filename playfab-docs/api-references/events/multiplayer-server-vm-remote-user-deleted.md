---
title: multiplayer_server_vm_remote_user_deleted
author: joannaleecy
description: multiplayer_server_vm_remote_user_deleted event.
ms.author: joanlee
ms.date: 02/19/2019
ms.topic: article
...
|Payload|[MultiplayerServerVmRemoteUserDeletedEventPayload](data-types/multiplayerservervmremoteuserdeletedeventpayload.md)|The multiplayer server virtual machine remote user deleted event payload.|
