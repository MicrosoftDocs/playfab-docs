---
title: player_left_lobby
author: joannaleecy
description: player_left_lobby event.
ms.author: joanlee
ms.date: 02/19/2019
ms.topic: article
ms.service: playfab
...
| :--------------------|:-------------------|:----------------------|
|GameMode|String|Game mode of the game session the player joined.|
|LobbyId|String|Unique ID of the game session the player joined.|
