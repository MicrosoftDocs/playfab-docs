---
title: multiplayer_server_vm_unhealthy
author: joannaleecy
description: multiplayer_server_vm_unhealthy event.
ms.author: joanlee
ms.date: 02/19/2019
ms.topic: article
...
|Payload|[MultiplayerServerVmUnhealthyEventPayload](data-types/multiplayerservervmunhealthyeventpayload.md)|The multiplayer server virtual machine unassignment started event payload.|
