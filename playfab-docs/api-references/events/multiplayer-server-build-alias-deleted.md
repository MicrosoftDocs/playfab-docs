...
|Payload|[MultiplayerServerBuildAliasDeletedEventPaylod](data-types/multiplayerserverbuildaliasdeletedeventpayload.md)|The multiplayer server build alias deleted event payload.|
