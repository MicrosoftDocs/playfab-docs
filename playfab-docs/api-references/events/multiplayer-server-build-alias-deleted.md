---
title: multiplayer_server_build_alias_deleted 
author: vorelien
description: multiplayer_server_build_alias_deleted event.
ms.author: vorelien
ms.date: 02/19/2019
ms.topic: article
...
# multiplayer_server_build_alias_deleted 
...
|Payload|[MultiplayerServerBuildAliasDeletedEventPayload](data-types/multiplayerserverbuildaliasdeletedeventpayload.md)|The multiplayer server build alias deleted event payload.|
