---
title: multiplayer_server_vm_state_change
author: vorelien
description: multiplayer_server_vm_state_change event.
ms.author: vorelien
ms.date: 12/09/2025
ms.topic: article
...
# multiplayer_server_vm_state_change
...
|Payload|[MultiplayerServerVmStateChangeEventPayload](data-types/multiplayerservervmstatechangeeventpayload.md)|The multiplayer server vm state change event payload.|
