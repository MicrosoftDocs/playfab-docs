...
author: vorelien
description: multiplayer_server_build_alias_created event.
ms.author: vorelien
ms.date: 02/19/2019
ms.topic: article
...
# multiplayer_server_build_alias_created 
...
|Payload|[MultiplayerServerBuildAliasCreatedEventPayload](data-types/multiplayerserverbuildaliascreatedeventpayload.md)|The multiplayer server build alias created event payload.|
