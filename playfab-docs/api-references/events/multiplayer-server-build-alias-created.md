...
|Payload|[MultiplayerServerBuildAliasCreatedEventPaylod](data-types/multiplayerserverbuildaliascreatedeventpayload.md)|The multiplayer server build alias created event payload.|
