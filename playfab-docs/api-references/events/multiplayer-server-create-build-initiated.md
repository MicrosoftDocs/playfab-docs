...
|Payload|[MultiplayerServerCreateBuildInitiatedEventPayload](data-types/multiplayerservercreatebuildinitiatedeventpayload.md)|The multiplayer server create build initiated event payload.|
