...
|Payload|[MultiplayerServerCertificateUploadedEventPayload](data-types/multiplayerservercertificateuploadedeventpayload.md)|The multiplayer server certificate uploaded event payload.|
