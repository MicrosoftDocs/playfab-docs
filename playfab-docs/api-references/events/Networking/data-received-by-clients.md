---
title: data_received_by_clients
author: raulalbertog
description: data_received_by_clients event.
...
|DataSizeInBytes|uint64|The total data size in bytes received by clients from the cloud service.|
