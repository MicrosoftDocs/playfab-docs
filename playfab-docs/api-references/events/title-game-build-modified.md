---
title: title_game_build_modified
author: v-thopra
description: title_game_build_modified event.
ms.author: v-thopra
ms.date: 02/19/2019
ms.topic: article
ms.prod: playfab
...
|Regions|[Region](data-types/region.md)|List of regions where the build has been deployed.|
|UserId|String||
