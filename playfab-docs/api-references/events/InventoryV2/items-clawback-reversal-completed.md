---
title: items_clawback_reversal_completed
author: ernestoc
description: items_clawback_reversal_completed event.
ms.author: ernestoc
ms.date: 02/18/2026
ms.topic: article
...
# items_clawback_reversal_completed
...
| Payload | [ItemsClawbackReversalCompletedPayload](../data-types/itemsclawbackreversalcompletedpayload.md) | The items clawback reversal completed event payload. |
