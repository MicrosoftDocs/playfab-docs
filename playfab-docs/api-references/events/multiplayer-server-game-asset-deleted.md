---
title: multiplayer_server_game_asset_deleted
author: joannaleecy
description: multiplayer_server_game_asset_deleted event.
ms.author: joanlee
ms.date: 02/19/2019
ms.topic: article
...
|Payload|[MultiplayerServerGameAssetDeletedEventPayload](data-types/multiplayerservergameassetdeletedeventpayload.md)|The multiplayer server game asset deleted event payload.|
