---
title: multiplayer_server_certificate_deleted 
author: joannaleecy
description: multiplayer_server_certificate_deleted event.
ms.author: joanlee
ms.date: 02/19/2019
ms.topic: article
...
|Payload|[MultiplayerServerCertificateDeletedEventPayload](data-types/multiplayerservercertificatedeletedeventpayload.md)|The multiplayer server certificate deleted event payload.|
