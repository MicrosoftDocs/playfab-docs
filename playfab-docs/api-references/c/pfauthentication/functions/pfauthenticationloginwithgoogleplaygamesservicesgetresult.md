---
author: jasonsandlin
title: "PFAuthenticationLoginWithGooglePlayGamesServicesGetResult"
description: "Get the result from a PFAuthenticationLoginWithGooglePlayGamesServicesAsync call. The PFEntityHandle will always be returned, but the additional info in the PFAuthenticationLoginResult is only returned if a buffer is provided."
ms.author: jasonsa
ms.topic: reference
...
```cpp
HRESULT PFAuthenticationLoginWithGooglePlayGamesServicesGetResult(  
    XAsyncBlock* async,  
