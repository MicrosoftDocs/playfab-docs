---
author: jasonsandlin
title: "PFLeaderboardsGetLeaderboardGetResultSize"
description: "Get the size in bytes needed to store the result of a GetLeaderboard call."
ms.author: jasonsa
ms.topic: reference
...
# PFLeaderboardsGetLeaderboardGetResultSize  
...
```cpp
HRESULT PFLeaderboardsGetLeaderboardGetResultSize(  
    XAsyncBlock* async,  
    size_t* bufferSize  
)  
```  
