---
author: jasonsandlin
title: "PFLeaderboardsGetLeaderboardDefinitionGetResultSize"
description: "Get the size in bytes needed to store the result of a GetLeaderboardDefinition call."
ms.author: jasonsa
ms.topic: reference
...
# PFLeaderboardsGetLeaderboardDefinitionGetResultSize  
...
```cpp
HRESULT PFLeaderboardsGetLeaderboardDefinitionGetResultSize(  
    XAsyncBlock* async,  
    size_t* bufferSize  
)  
```  
