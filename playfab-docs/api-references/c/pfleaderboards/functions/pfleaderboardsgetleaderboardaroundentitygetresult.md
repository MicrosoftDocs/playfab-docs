---
author: jasonsandlin
title: "PFLeaderboardsGetLeaderboardAroundEntityGetResult"
description: "Gets the result of a successful PFLeaderboardsGetLeaderboardAroundEntityAsync call."
ms.author: jasonsa
ms.topic: reference
...
# PFLeaderboardsGetLeaderboardAroundEntityGetResult  
...
```cpp
HRESULT PFLeaderboardsGetLeaderboardAroundEntityGetResult(  
    XAsyncBlock* async,  
    size_t bufferSize,  
    void* buffer,  
