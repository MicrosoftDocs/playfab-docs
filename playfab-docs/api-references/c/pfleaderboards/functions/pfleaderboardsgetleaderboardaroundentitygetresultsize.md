---
author: jasonsandlin
title: "PFLeaderboardsGetLeaderboardAroundEntityGetResultSize"
description: "Get the size in bytes needed to store the result of a GetLeaderboardAroundEntity call."
ms.author: jasonsa
ms.topic: reference
...
# PFLeaderboardsGetLeaderboardAroundEntityGetResultSize  
...
```cpp
HRESULT PFLeaderboardsGetLeaderboardAroundEntityGetResultSize(  
    XAsyncBlock* async,  
    size_t* bufferSize  
)  
```  
