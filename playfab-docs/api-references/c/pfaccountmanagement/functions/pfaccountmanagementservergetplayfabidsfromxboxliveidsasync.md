...
This API is available on Win32. When the asynchronous task is complete, call [PFAccountManagementServerGetPlayFabIDsFromXboxLiveIDsGetResultSize](pfaccountmanagementservergetplayfabidsfromxboxliveidsgetresultsize.md) and [PFAccountManagementServerGetPlayFabIDsFromXboxLiveIDsGetResult](pfaccountmanagementservergetplayfabidsfromxboxliveidsgetresult.md) to get the result.
