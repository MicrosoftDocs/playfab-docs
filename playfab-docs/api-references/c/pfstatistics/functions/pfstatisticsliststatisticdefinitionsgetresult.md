---
author: jasonsandlin
title: "PFStatisticsListStatisticDefinitionsGetResult"
description: "Gets the result of a successful PFStatisticsListStatisticDefinitionsAsync call."
ms.author: jasonsa
ms.topic: reference
...
# PFStatisticsListStatisticDefinitionsGetResult  
...
```cpp
HRESULT PFStatisticsListStatisticDefinitionsGetResult(  
    XAsyncBlock* async,  
    size_t bufferSize,  
    void* buffer,  
...
**`result`** &nbsp; [PFStatisticsListStatisticDefinitionsResponse**](../../pfstatisticstypes/structs/pfstatisticsliststatisticdefinitionsresponse.md)  
