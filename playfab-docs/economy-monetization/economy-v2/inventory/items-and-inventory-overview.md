...
For more information on how to use these APIs and other related APIs, please refer to the [PlayFab Inventory API documentation](/rest/api/playfab/economy/inventory?view=playfab-rest) 
