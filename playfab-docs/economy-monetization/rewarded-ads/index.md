...
> [!TIP]
> Additionally, leverage player [Segments](../../analytics/segmentation/index.md) to set overrides that allow different groups of players to receive different rewards. For example, reward your VIP players with a special item while other players are rewarded with currency. 
