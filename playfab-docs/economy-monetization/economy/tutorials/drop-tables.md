...
You can manually use a drop table from [CloudScript](../../../live-service-management/service-gateway/automation/cloudscript/writing-custom-cloudscript.md), using one of these Server API methods:
