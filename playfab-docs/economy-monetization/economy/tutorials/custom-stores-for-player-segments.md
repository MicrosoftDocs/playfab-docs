...
In our [Player segmentation quickstart](../../../live-service-management/game-configuration/segmentation/segmentation-quickstart.md), we provide an example of how to group your players into segments, based on player information or behavior.
