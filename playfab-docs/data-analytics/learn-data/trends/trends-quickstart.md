...
The Trends tab is updated once daily at the close of the UTC day. For details on each metric, see [Metrics and terminology](../reports/metrics-and-terminology.md).
...
![Trends Tab](../../legacy/media/tutorials/trends-tab.png)
...
![Screenshot of the dashboard when filters are used](../../legacy/media/tutorials/filters.png)
...
![Example summary view using Spark Card](../../legacy/media/tutorials/spark-card.png)  
...
![Screenshot of the trends interface for Graphs](../../legacy/media/tutorials/graph.png)
