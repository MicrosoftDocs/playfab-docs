...
Report times are based on Coordinated Universal Time (UTC). For additional details on metrics, see [Metrics and Terminology](../../../live-service-management/analytics/metrics/metrics-and-terminology.md).
