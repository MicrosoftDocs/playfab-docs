...
However PlayFab does offer an [email verification feature](../../live-service-management/runtime/engagement/emails/using-a-rule-to-verify-a-contact-email-address.md). But our solution isn't the only option for verification. You can create your own process too.
