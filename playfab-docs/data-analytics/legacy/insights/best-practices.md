...
### How can I query data?
   ...
   1. The simplest way is to use our built-in [data explorer](../../learn-data/data-explorer/index.md).
...
### How do I get data into my Insights cluster?
   ...
   2. You can also implement your own telemetry [through PlayStream, or our Telemetry system](../../ingest-data/playstream-events.md).
   3. You can use [Management Commands](management-commands.md) to ingest custom datasets.
...
- Follow the [PlayFab User Roles](../../../identity/dev-identity/permissions/playfab-user-roles.md) guide to access, create, and grant user permissions.
