...
- Updating [Title Data](../../../live-service-management/game-configuration/titledata/index.md) to reflect changes for a current event.
...
Automated tasks can take predefined actions or execute [CloudScript](../../../live-service-management/service-gateway/automation/cloudscript/index.md), which enables any custom server-side functionality you want to implement.
