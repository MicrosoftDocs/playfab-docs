...
- Updating [Title Data](../../../live-service-management/production/titledata/index.md) to reflect changes for a current event.
...
Automated tasks can take predefined actions or execute [CloudScript](../../../live-service-management/production/automation/cloudscript/index.md), which enables any custom server-side functionality you want to implement.
