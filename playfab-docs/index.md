...
<div id="main" class="v2">
    <div class="container">
        <ul class="cardsY panelContent featuredContent">
            <li>
                <a href="/playfab/release-notes">
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                <div class="cardImageOuter">
                                    <div class="cardImage">
                                        <img data-hoverimage="http://docs.microsoft.com/azure/media/index/getstarted-developer.svg" src="http://docs.microsoft.com/azure/media/index/getstarted-developer.png" alt="" />
                                    </div>
                                </div>
                                <div class="cardText">
                                    <span class="likeAnH3">Release Notes</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <li>
                <a href="/playfab/api-references">
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                <div class="cardImageOuter">
                                    <div class="cardImage">
                                        <img data-hoverimage="http://docs.microsoft.com/azure/media/index/getstarted-architecture.png" src="http://docs.microsoft.com/azure/media/index/getstarted-architecture.png" alt="" />
                                    </div>
                                </div>
                                <div class="cardText">
                                    <span class="likeAnH3">API References</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <li>
                <a href="/playfab/playfab_status">
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                <div class="cardImageOuter">
                                    <div class="cardImage">
                                        <img data-hoverimage="http://docs.microsoft.com/azure/media/index/getstarted_pluralsight.svg" src="http://docs.microsoft.com/azure/media/index/getstarted_pluralsight.png" alt="" />
                                    </div>
                                </div>
                                <div class="cardText">
                                    <span class="likeAnH3">PlayFab Status</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Player Encryption Services</h3>
                                                    <p>Lorem ipsum</p>
                                                </div>
                                            </div>
                                        </div>
