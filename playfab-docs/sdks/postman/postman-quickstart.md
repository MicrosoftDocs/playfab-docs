...
One way to interact with PlayFab's [Entity Programming Model](../../live-service-management/game-configuration/entities/index.md) is to get a Title Entity Token. This can be useful if you want to make changes to title config data, or if you want to make adjustments to a large number of players:
...
Another way to interact with PlayFab's [Entity Programming Model](../../live-service-management/game-configuration/entities/index.md) is to get a Title_Player_Account Entity Token. This is useful if you want to make changes to a single player:
...
> [PlayFab Quickstarts >](../../live-service-management/gamemanager/quickstart.md)
> [!div class="nextstepaction"]
