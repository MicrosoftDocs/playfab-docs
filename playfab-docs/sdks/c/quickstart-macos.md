...
This quickstart helps you make your first PlayFab API call using the macOS SDK. Before continuing, make sure you've completed the steps in [Quickstart: Game Manager](../../live-service-management/gamemanager/quickstart.md), which ensure you have a PlayFab account and are familiar with the PlayFab Game Manager.
...
4. After importing the binaries successfully, HttpClient_macOS, PlayFabCore_macOS and PlayFabServices_macOS, are listed under Frameworks, Libraries, and Embedded Content.
