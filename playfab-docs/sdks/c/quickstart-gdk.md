...
This quickstart helps you make your first PlayFab API call using the GDK. Before continuing, make sure you've completed the steps in [Quickstart: Game Manager](../../live-service-management/gamemanager/quickstart.md), which ensure you have a PlayFab account and are familiar with the PlayFab Game Manager.
